...
#+BEGIN_SRC sh
  ...
  factory.geom_files : string[3] as path = \
    ...
    "@HPGE_SIMULATION_DIR@/setup.geom"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  stacked.model_1 : string = "petri_boxmodel"
  ...
  mapping.daughter_id.petri    : string = "[petri.category:boite=0]"
...
#+BEGIN_SRC sh
  ...
  mapping.daughter_id.setup : string  = "[setup:volume=0]"
#+END_SRC
** Mapping categories
:PROPERTIES:
...
#+BEGIN_SRC sh
  ...
  materials.files : string[4] as path =   \
      ...
      "@HPGE_SIMULATION_DIR@/materials_aliases.def"
#+END_SRC
*** Material aliases
:PROPERTIES:
...
#+BEGIN_SRC sh
  ...
  manager.field_definitions_filenames : string[1] as path = \
      "@HPGE_SIMULATION_DIR@/magnetic_field_drivers.conf"
#+END_SRC
