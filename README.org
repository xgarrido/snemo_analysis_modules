...
#+BEGIN_SRC sh
  ...
  modules.configuration_files : string[1] as path = \
      "@SNEMO_SIMULATION_MODULES_DIR@/snemo_bb0nu_studies_modules.conf"
#+END_SRC
...
** Source code compilation                                     :toberefined:
...
** Use and execute =snemo_bb0nu_studies= module                :toberefined:
