 ...
 * Description:
 *
 *   Simulated data bank plotter.
 *
 * History:
 *
 */

#ifndef SNEMO_ANALYSIS_SIMULATED_DATA_PLOTTER_H
#define SNEMO_ANALYSIS_SIMULATED_DATA_PLOTTER_H 1
...
namespace analysis {
  ...
  class simulated_data_plotter : public ::snemo::analysis::base_plotter
  {
  public:
    ...
    /// Default constructor
    simulated_data_plotter(datatools::logger::priority p_ = datatools::logger::PRIO_FATAL);

    /// Destructor
    virtual ~simulated_data_plotter();
...
DOCD_CLASS_DECLARATION(snemo::analysis::simulated_data_plotter)

#endif // SNEMO_ANALYSIS_SIMULATED_DATA_PLOTTER_H
