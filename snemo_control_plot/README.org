...
section which is organized by data bank related plot.
...
#+BEGIN_SRC sh
  dpp_processing                                                       \
      ...
      --load-dll mctools_bio                                           \
      --input-file <path to a data record>
#+END_SRC

*TODO: Check why the =mctools_bio= library must be added to avoid segmentation fault*
