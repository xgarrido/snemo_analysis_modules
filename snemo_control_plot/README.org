...
#+BEGIN_SRC sh
  ...
  service_manager.configuration : string[1] as path = \
      "${SNEMO_CONTROL_PLOT_DIR}/config/pipeline/service_manager.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  modules.configuration_files : string[1] as path = \
      "${SNEMO_CONTROL_PLOT_DIR}/config/pipeline/snemo_control_plot_module.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  services.configuration_files : string[1] as path = \
      "${SNEMO_CONTROL_PLOT_DIR}/config/pipeline/services.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  [name="scp_module" type="snemo::snemo_control_plot_module"]
...
#+BEGIN_SRC sh
  ...
  pool.histo.setups : string[1] as path = \
      "${SNEMO_CONTROL_PLOT_DIR}/config/pipeline/histogram_templates.conf"
#+END_SRC
...
First, you need to compile the =snemo_control_plot= module files. The build
...
#+BEGIN_SRC sh
  ...
  cmake                                                                                                  \
      -DCMAKE_PREFIX_PATH="<path to Cadfael install>;<path to Bayeux install>;<path to Falaise install>" \
